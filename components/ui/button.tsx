...
const buttonVariants = cva(
  "inline-flex h-12 items-center justify-center gap-2 rounded-full px-6 text-sm font-medium transition duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-black text-white shadow-[0_18px_50px_rgba(0,0,0,0.22)] hover:bg-purple",
        outline: "border border-white/45 bg-white/10 text-white backdrop-blur-xl hover:border-purple hover:bg-purple/25",
        ghost: "text-black hover:bg-purple-soft"
      },
      size: {
        default: "h-12 px-6",
        icon: "h-12 w-12 px-0"
